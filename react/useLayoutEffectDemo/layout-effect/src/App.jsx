...
// function App() {
//   const [content,setContent] = useState('abdbsadawjjdjjassssssssssssswwwwwwwwwwwwwwwwkdakldhjakwdhkadjlalwjdkldhawldhawlkdhawoudhawjldjhawdawjd');
//   const ref = useRef();
//   // useEffect(() => {
...
function Modal() {
  ...
  return <div ref={ref} style={{background: 'red',position: 'absolute', width: '200px',color:'black',width: '200px '}}>我是弹窗</div>
}
